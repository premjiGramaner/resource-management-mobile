...
import { BaseResponce, skill as Skill } from 'src/app/core/base-model/base.model';

export interface benchResponse extends BaseResponce {
    data: {
        resourceCount?: number;
        resourceInfo: benchResourceData[];
    };

}

export interface benchResourceData {
...
export interface deleteResourceResponce extends BaseResponce {

    data: {
        resourceInfo: benchResourceData | boolean
    },
